...
|   [03 - Supervised learning](https://github.com/Ivan-Bebeshko/Yandex_Practicum/blob/96642273daf62e635f8fc72ac821ec86bba8c263/02%20-%20ML_introduction/02_ML_intro.ipynb)   | Сustomer retention predict | - Create model which predict customer exit.<br /> - Meet `f1` and `AUC-ROC` key metrics. |`pandas`, `numpy`, `matplotlib`, `math`, `stats`, `sklearn`|
